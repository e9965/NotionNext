...
const BLOG = {
  AUTHOR: 'PureCo2Fe', // 作者
  BIO: '☕一個普普通通的中學生', // 作者简介
  LINK: 'https://co2fe.cf', // 网站地址
  AVATAR: '/avatar.png', // 个人头像 默认取public目录下的avatar.png
  KEYWORDS: 'Notion, 博客, PureCo2Fe, Co2Fe, Study Blog', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '7c5f735a4ef44f969441133a847739f1', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  NOTION_ACCESS_TOKEN: process.env.NOTION_ACCESS_TOKEN || '', // Useful if you prefer not to make your database public
  DEBUG: process.env.NEXT_PUBLIC_DEBUG || false, // 是否显示调试按钮

  THEME: process.env.NEXT_PUBLIC_THEME || 'hexo', // 主题， 支持 ['next','hexo',"fukasawa','medium']
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || false, // 是否显示切换主题按钮
  LANG: 'zh-HK', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  FONT_AWESOME_PATH: 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css', // 图标库CDN ，国内推荐BootCDN https://cdn.bootcdn.net/ajax/libs/font-awesome/5.15.4/css/all.min.css，国外推荐 CloudFlare https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css
  ...
  WIDGET_PET_LINK: 'https://cdn.jsdelivr.net/npm/live2d-widget-model-koharu@1.0.5/assets/koharu.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  COMMENT_GISCUS_EMIT_METADATA: process.env.NEXT_PUBLIC_COMMENT_GISCUS_EMIT_METADATA || '1', // 你的 Giscus 是否提取 Metadata '1' 開啟 '0' 關閉 預設關閉
  ...
  // 无关紧要的配置
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'PureCo2Fe @ NotionNext BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || 'StudyBlog For PureCo2Fe', // 站点描述，被notion中的页面描述覆盖
